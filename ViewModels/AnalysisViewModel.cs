...
namespace LogAnalysisTool.ViewModels
{
    ...
    {
        private const string trainingModelFileName = "model.zip";
        ...
        private void ModelTraining()
        {
            ...
            // Save model
            context.Model.Save(trainedModel, testingDataView.Schema, trainingModelFileName);
        }
        ...
        private void Prediction(CancellationToken cancellationToken)
        {
            ...
            ITransformer predictionPipeline = mlContext.Model.Load(trainingModelFileName, out predictionPipelineSchema);
            ...
            ApacheLogFile GetDataItem(Match m, int lineCounter)
            {
